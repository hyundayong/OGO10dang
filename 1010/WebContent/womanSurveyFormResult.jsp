...
<body>
   ...
   <div class="womansurveyForm">
   		<form action="womanSurveyFormResult.pre" method="POST">
   			<fieldset>
   				<legend>기본 정보</legend>
   				<table>
   					<tr><td class="labelwidth"><label for="name">이름</label></td>
   					<td><input type="text" name="name" id="name" value='<%=bodyInfoList.getName()%>'></td></tr>
   					...
   					<td><input type="number" name="age" id="age" min="1" max="150" required value='<%=bodyInfoList.getAge()%>'/></td></tr>
   					<tr><td class="labelwidth"><label for="height">키</label></td>
   					<td><input type="number" name="height" id="height" min="0" style="display: inline;" required value='<%=bodyInfoList.getHeight()%>'/></td>
   					<td>&nbsp;( cm )</td></tr>
   					<tr><td class="labelwidth"><label for="weight">몸무게</label></td>
   					<td><input type="number" name="weight" id="weight" min="0" required value='<%=bodyInfoList.getWeight()%>'/></td>
   					<td>&nbsp;( kg )</td></tr>
   				</table>
   			...
   			<fieldset>
   			 ...
   			 <div class="buttons">
   			 	<input id="submitButton" type="submit" value="정보 수정">&nbsp;&nbsp;
