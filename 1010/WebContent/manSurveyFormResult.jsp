         ...
         <form action="manSurveyFormResult.pre" method="POST">
            <fieldset>
               ...
               <label for="name">이름</label>
                  <input type="text" name="name" id="name" required value='<%=bodyInfoList.getName()%>'/><br><br>
               <label for="gender">성별</label>
                  <input type="radio" name="gender" value="man" checked> 남자 
                   <input type="radio" name="gender" value="woman" disabled> 여자<br><br>
               <label for="age">나이</label>
                  <input type="number" name="age" id="age" min="1" max="150" required value='<%=bodyInfoList.getAge()%>'/><br><br>
               <label for="height">키</label>
                  <input type="number" name="height" id="height" min="0" required value='<%=bodyInfoList.getHeight()%>'/> ( cm )<br><br>
               <label for="weight">몸무게</label>
                  <input type="number" name="weight" id="weight" min="0" required value='<%=bodyInfoList.getWeight()%>'/> ( kg )<br><br>
            </fieldset>
