...
public class SurveyDAO {
	...
	public int isSurveyComplete_M (String id) {
		...
		System.out.println("surveyComplete1 = "+surveyComplete);
	...
	public int isSurveyComplete_W (String id) {
		...
		System.out.println("surveyComplete2 = "+surveyComplete);
		return surveyComplete;
	}
	...
	public BodyInfo selectWBodyInfo(String id) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public BodyInfo selectMBodyInfo(String id) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		BodyInfo bodyinfoSettingBean = null;
		
		System.out.println("DAO(M) : session ID = "+id);
		System.out.println("selectMBodyInfo DAO 입장 ");
